...
import noneJob from "../../../assests/imgs/none-job.png";
// const freelancers = [
//   {
//     id: 1,
  ...
  return (
    <>
      {listFreelancer.length ? (
        <div className="grid grid-cols-3 grid-rows-1 gap-10 mb-8">
        ...
        <div className="flex justify-center items-center flex-col w-full">
          <img className="h-96" src={noneJob} alt="img" />
          <h2 className="text-blue-500 font-bold text-2xl">Tạm thời chưa có freelancer ở lĩnh vực này!</h2>
        </div>
      )}
    </>
  );
