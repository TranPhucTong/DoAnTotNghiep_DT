...
const ItemCategory = ({ category, onChangeCategory, categoryActive }) => {
  ...
  return (
    <div
      ...
      className={`flex justify-start items-center my-2 -translate-x-[8%] hover:translate-x-0 transition-all duration-500 cursor-pointer hover:text-black text-slate-700 ${ value === categoryActive.value && 'text-black translate-x-0'}`}
    >
